...
namespace ASCOM.Alpaca.Client.Devices
{
    public sealed class Switch : DeviceBase, ISwitch {
        public Switch(DeviceConfiguration configuration, IClientTransactionIdGenerator clientTransactionIdGenerator, ICommandSender commandSender, ILogger logger) : base(configuration, clientTransactionIdGenerator, commandSender, logger)
        {
        }
        ...
        private IRestRequest BuildGetMaxSwitchRequest() => RequestBuilder.BuildRestRequest(SwitchMethod.MaxSwitch, Method.GET, ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildCanWriteRequest(int id) => RequestBuilder.BuildRestRequest(SwitchMethod.CanWrite, Method.GET, GetDefaultParameters(id), ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildGetSwitchRequest(int id) => RequestBuilder.BuildRestRequest(SwitchMethod.GetSwitch, Method.GET, GetDefaultParameters(id), ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildGetSwitchDescriptionRequest(int id) => RequestBuilder.BuildRestRequest(SwitchMethod.GetSwitchDescription, Method.GET, GetDefaultParameters(id), ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildGetSwitchNameRequest(int id) => RequestBuilder.BuildRestRequest(SwitchMethod.GetSwitchName, Method.GET, GetDefaultParameters(id), ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildGetSwitchValueRequest(int id) => RequestBuilder.BuildRestRequest(SwitchMethod.GetSwitchValue, Method.GET, GetDefaultParameters(id), ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildGetMinSwitchValueRequest(int id) => RequestBuilder.BuildRestRequest(SwitchMethod.MinSwitchValue, Method.GET, GetDefaultParameters(id), ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildGetMaxSwitchValueRequest(int id) => RequestBuilder.BuildRestRequest(SwitchMethod.MaxSwitchValue, Method.GET, GetDefaultParameters(id), ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildGetSwitchStepRequest(int id) => RequestBuilder.BuildRestRequest(SwitchMethod.SwitchStep, Method.GET, GetDefaultParameters(id), ClientTransactionIdGenerator.GetTransactionId());
