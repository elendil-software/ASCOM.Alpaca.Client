...
namespace AscomAlpacaClient.Devices
{
    public sealed class Switch : DeviceBase, ISwitch 
    {
        ...
        private IRestRequest BuildGetMaxSwitchRequest() => RequestBuilder.BuildRestRequest(SwitchMethod.MaxSwitch, Method.GET, GetClientTransactionId());
        ...
        private IRestRequest BuildCanWriteRequest(int id) => RequestBuilder.BuildRestRequest(SwitchMethod.CanWrite, Method.GET, GetDefaultParameters(id), GetClientTransactionId());
        ...
        private IRestRequest BuildGetSwitchRequest(int id) => RequestBuilder.BuildRestRequest(SwitchMethod.GetSwitch, Method.GET, GetDefaultParameters(id), GetClientTransactionId());
        ...
        private IRestRequest BuildSetSwitchRequest(int id, bool state)
        {
            ...
            return RequestBuilder.BuildRestRequest(SwitchMethod.SetSwitch, Method.PUT, parameters, GetClientTransactionId());
        }
        ...
        private IRestRequest BuildGetSwitchDescriptionRequest(int id) => RequestBuilder.BuildRestRequest(SwitchMethod.GetSwitchDescription, Method.GET, GetDefaultParameters(id), GetClientTransactionId());
        ...
        private IRestRequest BuildGetSwitchNameRequest(int id) => RequestBuilder.BuildRestRequest(SwitchMethod.GetSwitchName, Method.GET, GetDefaultParameters(id), GetClientTransactionId());
        ...
        private IRestRequest BuildSetSwitchNameRequest(int id, string name)
        {
            ...
            return RequestBuilder.BuildRestRequest(SwitchMethod.SetSwitchName, Method.PUT, parameters, GetClientTransactionId());
        }
        ...
        private IRestRequest BuildGetSwitchValueRequest(int id) => RequestBuilder.BuildRestRequest(SwitchMethod.GetSwitchValue, Method.GET, GetDefaultParameters(id), GetClientTransactionId());
        ...
        private IRestRequest BuildSetSwitchValueRequest(int id, double value)
        {
            ...
            return RequestBuilder.BuildRestRequest(SwitchMethod.SetSwitchValue, Method.PUT, parameters, GetClientTransactionId());
        }
        ...
        private IRestRequest BuildGetMinSwitchValueRequest(int id) => RequestBuilder.BuildRestRequest(SwitchMethod.MinSwitchValue, Method.GET, GetDefaultParameters(id), GetClientTransactionId());
        ...
        private IRestRequest BuildGetMaxSwitchValueRequest(int id) => RequestBuilder.BuildRestRequest(SwitchMethod.MaxSwitchValue, Method.GET, GetDefaultParameters(id), GetClientTransactionId());
        ...
        private IRestRequest BuildGetSwitchStepRequest(int id) => RequestBuilder.BuildRestRequest(SwitchMethod.SwitchStep, Method.GET, GetDefaultParameters(id), GetClientTransactionId());
