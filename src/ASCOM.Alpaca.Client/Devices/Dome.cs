...
namespace ASCOM.Alpaca.Client.Devices
{
    public sealed class Dome : DeviceBase, IDome
    {
        ...
        private IRestRequest BuildGetAltitudeRequest() => RequestBuilder.BuildRestRequest(DomeMethod.Altitude, Method.GET, ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildIsAtHomeRequest() => RequestBuilder.BuildRestRequest(DomeMethod.AtHome, Method.GET, ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildIsAtParkRequest() => RequestBuilder.BuildRestRequest(DomeMethod.AtPark, Method.GET, ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildGetAzimuthRequest() => RequestBuilder.BuildRestRequest(DomeMethod.Azimuth, Method.GET, ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildCanFindHomeRequest() => RequestBuilder.BuildRestRequest(DomeMethod.CanFindHome, Method.GET, ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildCanParkRequest() => RequestBuilder.BuildRestRequest(DomeMethod.CanPark, Method.GET, ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildCanSetAltitudeRequest() => RequestBuilder.BuildRestRequest(DomeMethod.CanSetAltitude, Method.GET, ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildCanSetAzimuthRequest() => RequestBuilder.BuildRestRequest(DomeMethod.CanSetAzimuth, Method.GET, ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildCanSetParkRequest() => RequestBuilder.BuildRestRequest(DomeMethod.CanSetPark, Method.GET, ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildCanSetShutterRequest() => RequestBuilder.BuildRestRequest(DomeMethod.CanSetShutter, Method.GET, ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildCanSlaveRequest() => RequestBuilder.BuildRestRequest(DomeMethod.CanSlave, Method.GET, ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildIsSlavedRequest() => RequestBuilder.BuildRestRequest(DomeMethod.Slaved, Method.GET, ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildIsSlewingRequest() => RequestBuilder.BuildRestRequest(DomeMethod.Slewing, Method.GET, ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildAbortSlewRequest() => RequestBuilder.BuildRestRequest(DomeMethod.AbortSlew, Method.PUT, ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildCloseShutterRequest() => RequestBuilder.BuildRestRequest(DomeMethod.CloseShutter, Method.PUT, ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildFindHomeRequest() => RequestBuilder.BuildRestRequest(DomeMethod.FindHome, Method.PUT, ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildOpenShutterRequest() => RequestBuilder.BuildRestRequest(DomeMethod.OpenShutter, Method.PUT, ClientTransactionIdGenerator.GetTransactionId());
        
        public void Park() => ExecuteRequest(BuildParkRequest);
        public async Task ParkAsync() => await ExecuteRequestAsync(BuildParkRequest);
        private IRestRequest BuildParkRequest() => RequestBuilder.BuildRestRequest(DomeMethod.Park, Method.PUT, ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildSetParkRequest() => RequestBuilder.BuildRestRequest(DomeMethod.SetPark, Method.PUT, ClientTransactionIdGenerator.GetTransactionId());
