...
namespace ASCOM.Alpaca.Client.Devices
{
    ...
    {
        public Focuser(DeviceConfiguration configuration, IClientTransactionIdGenerator clientTransactionIdGenerator, ICommandSender commandSender, ILogger logger) : base(configuration, clientTransactionIdGenerator, commandSender, logger)
        {
        }
        ...
        private IRestRequest BuildIsAbsoluteRequest() => RequestBuilder.BuildRestRequest(FocuserMethod.Absolute, Method.GET, ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildIsMovingRequest() => RequestBuilder.BuildRestRequest(FocuserMethod.IsMoving, Method.GET, ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildGetMaxIncrementRequest() => RequestBuilder.BuildRestRequest(FocuserMethod.MaxIncrement, Method.GET, ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildGetMaxStepRequest() => RequestBuilder.BuildRestRequest(FocuserMethod.MaxStep, Method.GET, ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildGetPositionRequest() => RequestBuilder.BuildRestRequest(FocuserMethod.Position, Method.GET, ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildGetStepSizeRequest() => RequestBuilder.BuildRestRequest(FocuserMethod.StepSize, Method.GET, ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildIsTempCompRequest() => RequestBuilder.BuildRestRequest(FocuserMethod.TempComp, Method.GET, ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildIsTempCompAvailableRequest() => RequestBuilder.BuildRestRequest(FocuserMethod.TempCompAvailable, Method.GET, ClientTransactionIdGenerator.GetTransactionId());
        ...
        private IRestRequest BuildGetTemperatureRequest() => RequestBuilder.BuildRestRequest(FocuserMethod.Temperature, Method.GET, ClientTransactionIdGenerator.GetTransactionId());

        public void Halt() => ExecuteRequest(BuildHaltRequest);
        public async Task HaltAsync() => await ExecuteRequestAsync(BuildHaltRequest);
        private IRestRequest BuildHaltRequest() => RequestBuilder.BuildRestRequest(FocuserMethod.Halt, Method.PUT, ClientTransactionIdGenerator.GetTransactionId());
