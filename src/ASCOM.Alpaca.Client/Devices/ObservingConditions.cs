...
namespace ASCOM.Alpaca.Client.Devices
{
    public sealed class ObservingConditions : DeviceBase, IObservingConditions
    {
        ...
        private IRestRequest BuildRequest() => RequestBuilder.BuildRestRequest(ObservingConditionsMethod.AveragePeriod, Method.GET, ClientTransactionIdGenerator.GetTransactionId(Configuration.ClientId));
        ...
        private IRestRequest BuildSetAveragePeriodRequest(double period)
        {
            ...
            return RequestBuilder.BuildRestRequest(ObservingConditionsMethod.AveragePeriod, Method.PUT, parameters, ClientTransactionIdGenerator.GetTransactionId(Configuration.ClientId));
        }
        ...
        private IRestRequest BuildGetCloudCoverRequest() => RequestBuilder.BuildRestRequest(ObservingConditionsMethod.CloudCover, Method.GET, ClientTransactionIdGenerator.GetTransactionId(Configuration.ClientId));
        ...
        private IRestRequest BuildGetDewPointRequest() => RequestBuilder.BuildRestRequest(ObservingConditionsMethod.DewPoint, Method.GET, ClientTransactionIdGenerator.GetTransactionId(Configuration.ClientId));
        ...
        private IRestRequest BuildGetHumidityRequest() => RequestBuilder.BuildRestRequest(ObservingConditionsMethod.Humidity, Method.GET, ClientTransactionIdGenerator.GetTransactionId(Configuration.ClientId));
        ...
        private IRestRequest BuildGetPressureRequest() => RequestBuilder.BuildRestRequest(ObservingConditionsMethod.Pressure, Method.GET, ClientTransactionIdGenerator.GetTransactionId(Configuration.ClientId));
        ...
        private IRestRequest BuildGetRainRateRequest() => RequestBuilder.BuildRestRequest(ObservingConditionsMethod.RainRate, Method.GET, ClientTransactionIdGenerator.GetTransactionId(Configuration.ClientId));
        ...
        private IRestRequest BuildGetSkyBrightnessRequest() => RequestBuilder.BuildRestRequest(ObservingConditionsMethod.SkyBrightness, Method.GET, ClientTransactionIdGenerator.GetTransactionId(Configuration.ClientId));
        ...
        private IRestRequest BuildGetSkyQualityRequest() => RequestBuilder.BuildRestRequest(ObservingConditionsMethod.SkyQuality, Method.GET, ClientTransactionIdGenerator.GetTransactionId(Configuration.ClientId));
        ...
        private IRestRequest BuildGetSkyTemperatureRequest() => RequestBuilder.BuildRestRequest(ObservingConditionsMethod.SkyTemperature, Method.GET, ClientTransactionIdGenerator.GetTransactionId(Configuration.ClientId));
        ...
        private IRestRequest BuildGetStarFwhmRequest() => RequestBuilder.BuildRestRequest(ObservingConditionsMethod.StarFWHM, Method.GET, ClientTransactionIdGenerator.GetTransactionId(Configuration.ClientId));
        ...
        private IRestRequest BuildGetTemperatureRequest() => RequestBuilder.BuildRestRequest(ObservingConditionsMethod.Temperature, Method.GET, ClientTransactionIdGenerator.GetTransactionId(Configuration.ClientId));
        ...
        private IRestRequest BuildGetWindDirectionRequest() => RequestBuilder.BuildRestRequest(ObservingConditionsMethod.WindDirection, Method.GET, ClientTransactionIdGenerator.GetTransactionId(Configuration.ClientId));
        ...
        private IRestRequest BuildGetWindGustRequest() => RequestBuilder.BuildRestRequest(ObservingConditionsMethod.WindGust, Method.GET, ClientTransactionIdGenerator.GetTransactionId(Configuration.ClientId));
        ...
        private IRestRequest BuildGetWindSpeedRequest() => RequestBuilder.BuildRestRequest(ObservingConditionsMethod.WindSpeed, Method.GET, ClientTransactionIdGenerator.GetTransactionId(Configuration.ClientId));
        ...
        private IRestRequest BuildRefreshRequest() => RequestBuilder.BuildRestRequest(ObservingConditionsMethod.Refresh, Method.PUT, ClientTransactionIdGenerator.GetTransactionId(Configuration.ClientId));
        ...
        private IRestRequest BuildGetSensorDescriptionRequest(ObservingConditionSensorName sensorName)
        {
            ...
            return RequestBuilder.BuildRestRequest(ObservingConditionsMethod.SensorDescription, Method.GET, parameters, ClientTransactionIdGenerator.GetTransactionId(Configuration.ClientId));
        }
        ...
        private IRestRequest BuildGetTimeSinceLastUpdateRequest(ObservingConditionSensorName sensorName)
        {
            ...
            return RequestBuilder.BuildRestRequest(ObservingConditionsMethod.TimeSinceLastUpdate, Method.GET, parameters, ClientTransactionIdGenerator.GetTransactionId(Configuration.ClientId));
        }
    }
}