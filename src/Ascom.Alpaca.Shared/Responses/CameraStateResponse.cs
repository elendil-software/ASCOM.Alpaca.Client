...
namespace ES.Ascom.Alpaca.Responses
{
    ...
    public class CameraStateResponse : CommandResponse, IValueResponse<CameraState>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CameraStateResponse" /> class with the specified <paramref name="value"/>
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CameraStateResponse" /> class with the specified <paramref name="errorNumber"/> and <paramref name="errorMessage"/>
        /// </summary>
