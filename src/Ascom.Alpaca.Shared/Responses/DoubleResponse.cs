namespace ES.Ascom.Alpaca.Responses
{
    ...
    public class DoubleResponse : CommandResponse, IValueResponse<double>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DoubleResponse" /> class with the specified <paramref name="value"/>
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DoubleResponse" /> class with the specified <paramref name="errorNumber"/> and <paramref name="errorMessage"/>
        /// </summary>
