namespace ES.Ascom.Alpaca.Responses
{
    ...
    public class ImageArrayShort2DResponse : CommandResponse, IImageResponse<short[,]>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImageArrayShort2DResponse" /> class with the specified <paramref name="value"/>
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImageArrayShort2DResponse" /> class with the specified <paramref name="errorNumber"/> and <paramref name="errorMessage"/>
        /// </summary>
