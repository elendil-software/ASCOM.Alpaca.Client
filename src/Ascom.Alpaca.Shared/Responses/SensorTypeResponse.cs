...
namespace ES.Ascom.Alpaca.Responses
{
    ...
    public class SensorTypeResponse : CommandResponse, IValueResponse<SensorType>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SensorTypeResponse" /> class with the specified <paramref name="value"/>
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SensorTypeResponse" /> class with the specified <paramref name="errorNumber"/> and <paramref name="errorMessage"/>
        /// </summary>
