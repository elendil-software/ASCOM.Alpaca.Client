namespace ES.Ascom.Alpaca.Responses
{
    ...
    public class ImageArrayInt3DResponse : CommandResponse, IImageResponse<int[,,]>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImageArrayInt3DResponse" /> class with the specified <paramref name="value"/>
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImageArrayInt3DResponse" /> class with the specified <paramref name="errorNumber"/> and <paramref name="errorMessage"/>
        /// </summary>
