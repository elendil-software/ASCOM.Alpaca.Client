...
namespace ES.AscomAlpaca.Responses
{
    ...
    public class EquatorialCoordinateTypeResponse : CommandResponse, IValueResponse<EquatorialCoordinateType>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EquatorialCoordinateTypeResponse" /> class with the specified <paramref name="value"/>
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EquatorialCoordinateTypeResponse" /> class with the specified <paramref name="errorNumber"/> and <paramref name="errorMessage"/>
        /// </summary>
